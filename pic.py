...
def generate_image(input_image):
    with open("image2image.json", "r") as file_json:
        ...
        prompt["15"]["inputs"]["image"] = input_image
...
def queue_prompt(prompt): 
    ...
    req = urllib.request.Request(f"http://{URL}/api/prompt", data=data, headers={'Content-Type': 'application/json'}) 
    try: 
